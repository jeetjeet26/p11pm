-- Preserve native due_at deadlines in the reduced team payload and exclude
-- undated milestones from the deadline list.
...
as $$
  ...
  milestone_page as materialized (
    ...
    order by milestone.due_date, milestone.id
    limit 100
  ),
